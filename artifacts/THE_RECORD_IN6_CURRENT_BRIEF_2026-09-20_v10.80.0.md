...
## July 14, 2026 — Shreve votes yes on permanent daylight saving time and firearm-retailer code restrictions
...
## June 24, 2026 — Seventeen IN‑6 community-project requests advance through Appropriations
...
Maybe committee approval of all 17 requests is meaningful evidence of appropriations influence even before money is delivered. Therefore the $45 million should be tracked project by project through final bill text, enactment, obligation, and recipient or project execution as applicable; only amounts surviving each stage should be described as secured or delivered.
...
## May 6, 2026 — IN‑6 general election is set: Shreve versus Cinde Wirth
...
## April 20–21, 2026 — Shreve joins House Appropriations with three subcommittee assignments
...
Maybe Appropriations membership gives Shreve a legitimate institutional opportunity to direct federal attention and funding toward district needs. Therefore neither influence nor misuse should be inferred from the assignment alone; the claim changes only when requests, amendments, votes, oversight, conflicts, and resulting district outcomes show how the authority was used.

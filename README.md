...
Generated deterministically from canonical JSON for maintenance release **10.85.0**. Editorial news currentness was checked **2026-09-22 5:57 AM EDT**; QA inputs were updated **2026-09-22T10:08:28Z**.
...
| Current national entries bridged into the archive | 271 |
| Full archive entries rendered at runtime | 5,002 |
| Attached source references at runtime | 7,484 |
| Distinct stored source URLs at runtime | 6,093 |
| Current entries with Maybe / Therefore | 275 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 275 |

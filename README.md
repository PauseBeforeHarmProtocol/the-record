...
Generated deterministically from canonical JSON for maintenance release **8.7.0**. Editorial news currentness was checked **2026-08-26 12:02 PM EDT**; QA inputs were updated **2026-08-26T16:05:00Z**.
...
| Current national entries bridged into the archive | 32 |
| Full archive entries rendered at runtime | 4,771 |
| Attached source references at runtime | 6,780 |
| Distinct stored source URLs at runtime | 5,390 |
| Current entries with Maybe / Therefore | 36 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 36 |

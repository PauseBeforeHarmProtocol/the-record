...
Generated deterministically from canonical JSON for maintenance release **10.83.0**. Editorial news currentness was checked **2026-09-21 6:01 PM EDT**; QA inputs were updated **2026-09-21T22:01:39Z**.
...
| Current national entries bridged into the archive | 266 |
| Full archive entries rendered at runtime | 4,997 |
| Attached source references at runtime | 7,477 |
| Distinct stored source URLs at runtime | 6,086 |
| Current entries with Maybe / Therefore | 270 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 270 |

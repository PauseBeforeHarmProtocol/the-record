...
Generated deterministically from canonical JSON for maintenance release **10.20.0**. Editorial news currentness was checked **2026-09-03 11:59 PM EDT**; QA inputs were updated **2026-09-04T03:59:49Z**.
...
| Current national entries bridged into the archive | 122 |
| Full archive entries rendered at runtime | 4,853 |
| Attached source references at runtime | 7,042 |
| Distinct stored source URLs at runtime | 5,654 |
| Current entries with Maybe / Therefore | 126 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 126 |

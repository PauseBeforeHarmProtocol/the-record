...
Generated deterministically from canonical JSON for maintenance release **10.58.0**. Editorial news currentness was checked **2026-09-15 12:31 AM EDT**; QA inputs were updated **2026-09-15T04:40:00Z**.
...
| Current national entries bridged into the archive | 200 |
| Full archive entries rendered at runtime | 4,931 |
| Attached source references at runtime | 7,294 |
| Distinct stored source URLs at runtime | 5,905 |
| Current entries with Maybe / Therefore | 204 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 204 |

...
Generated deterministically from canonical JSON for maintenance release **10.74.0**. Editorial news currentness was checked **2026-09-18 6:32 PM EDT**; QA inputs were updated **2026-09-18T22:20:00Z**.
...
| Current national entries bridged into the archive | 251 |
| Full archive entries rendered at runtime | 4,982 |
| Attached source references at runtime | 7,433 |
| Distinct stored source URLs at runtime | 6,042 |
| Current entries with Maybe / Therefore | 255 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 255 |

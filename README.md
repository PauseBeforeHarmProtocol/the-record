...
Generated deterministically from canonical JSON for maintenance release **10.62.0**. Editorial news currentness was checked **2026-09-16 1:17 AM EDT**; QA inputs were updated **2026-09-16T04:25:00Z**.
...
| Current national entries bridged into the archive | 213 |
| Full archive entries rendered at runtime | 4,944 |
| Attached source references at runtime | 7,326 |
| Distinct stored source URLs at runtime | 5,937 |
| Current entries with Maybe / Therefore | 217 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 217 |

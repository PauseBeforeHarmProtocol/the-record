...
Generated deterministically from canonical JSON for maintenance release **10.38.0**. Editorial news currentness was checked **2026-09-08 11:58 PM EDT**; QA inputs were updated **2026-09-09T04:25:43.543975Z**.
...
| Current national entries bridged into the archive | 157 |
| Full archive entries rendered at runtime | 4,888 |
| Attached source references at runtime | 7,158 |
| Distinct stored source URLs at runtime | 5,770 |
| Current entries with Maybe / Therefore | 161 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 161 |

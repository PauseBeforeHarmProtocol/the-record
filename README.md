...
Generated deterministically from canonical JSON for maintenance release **10.61.0**. Editorial news currentness was checked **2026-09-15 6:02 PM EDT**; QA inputs were updated **2026-09-15T16:12:00Z**.
...
| Current national entries bridged into the archive | 207 |
| Full archive entries rendered at runtime | 4,938 |
| Attached source references at runtime | 7,315 |
| Distinct stored source URLs at runtime | 5,926 |
| Current entries with Maybe / Therefore | 211 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 211 |

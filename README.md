...
Generated deterministically from canonical JSON for maintenance release **8.8.0**. Editorial news currentness was checked **2026-08-26 5:59 PM EDT**; QA inputs were updated **2026-08-26T22:00:00Z**.
...
| Current national entries bridged into the archive | 36 |
| Full archive entries rendered at runtime | 4,775 |
| Attached source references at runtime | 6,789 |
| Distinct stored source URLs at runtime | 5,399 |
| Current entries with Maybe / Therefore | 40 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 40 |

...
Generated deterministically from canonical JSON for maintenance release **10.77.0**. Editorial news currentness was checked **2026-09-19 12:01 PM EDT**; QA inputs were updated **2026-09-19T16:01:18Z**.
...
| Current national entries bridged into the archive | 257 |
| Full archive entries rendered at runtime | 4,988 |
| Attached source references at runtime | 7,448 |
| Distinct stored source URLs at runtime | 6,057 |
| Current entries with Maybe / Therefore | 261 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 261 |

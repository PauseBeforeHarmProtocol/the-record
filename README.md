...
Generated deterministically from canonical JSON for maintenance release **10.70.1**. Editorial news currentness was checked **2026-09-18 12:33 AM EDT**; QA inputs were updated **2026-09-18T04:09:14Z**.
...
| Current national entries bridged into the archive | 238 |
| Full archive entries rendered at runtime | 4,969 |
| Attached source references at runtime | 7,397 |
| Distinct stored source URLs at runtime | 6,006 |
| Current entries with Maybe / Therefore | 242 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 242 |

...
Generated deterministically from canonical JSON for maintenance release **10.62.0**. Editorial news currentness was checked **2026-09-16 1:03 AM EDT**; QA inputs were updated **2026-09-16T04:25:00Z**.
...
| Current national entries bridged into the archive | 212 |
| Full archive entries rendered at runtime | 4,943 |
| Attached source references at runtime | 7,324 |
| Distinct stored source URLs at runtime | 5,935 |
| Current entries with Maybe / Therefore | 216 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 216 |

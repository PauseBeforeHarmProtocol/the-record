...
Generated deterministically from canonical JSON for maintenance release **10.51.0**. Editorial news currentness was checked **2026-09-13 6:01 AM EDT**; QA inputs were updated **2026-09-13T10:12:46Z**.
...
| Current national entries bridged into the archive | 188 |
| Full archive entries rendered at runtime | 4,919 |
| Attached source references at runtime | 7,249 |
| Distinct stored source URLs at runtime | 5,860 |
| Current entries with Maybe / Therefore | 192 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 192 |

...
Generated deterministically from canonical JSON for maintenance release **10.42.0**. Editorial news currentness was checked **2026-09-10 12:02 AM EDT**; QA inputs were updated **2026-09-10T04:02:20Z**.
...
| Current national entries bridged into the archive | 166 |
| Full archive entries rendered at runtime | 4,897 |
| Attached source references at runtime | 7,189 |
| Distinct stored source URLs at runtime | 5,801 |
| Current entries with Maybe / Therefore | 170 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 170 |

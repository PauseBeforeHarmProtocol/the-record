...
Generated deterministically from canonical JSON for maintenance release **10.66.0**. Editorial news currentness was checked **2026-09-16 12:33 PM EDT**; QA inputs were updated **2026-09-16T16:33:57Z**.
...
| Current national entries bridged into the archive | 225 |
| Full archive entries rendered at runtime | 4,956 |
| Attached source references at runtime | 7,355 |
| Distinct stored source URLs at runtime | 5,966 |
| Current entries with Maybe / Therefore | 229 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 229 |

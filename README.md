...
Generated deterministically from canonical JSON for maintenance release **10.73.0**. Editorial news currentness was checked **2026-09-18 5:59 PM EDT**; QA inputs were updated **2026-09-18T22:20:00Z**.
...
| Current national entries bridged into the archive | 249 |
| Full archive entries rendered at runtime | 4,980 |
| Attached source references at runtime | 7,426 |
| Distinct stored source URLs at runtime | 6,035 |
| Current entries with Maybe / Therefore | 253 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 253 |

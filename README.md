...
Generated deterministically from canonical JSON for maintenance release **10.52.0**. Editorial news currentness was checked **2026-09-13 11:59 AM EDT**; QA inputs were updated **2026-09-13T16:15:00Z**.
...
| Current national entries bridged into the archive | 189 |
| Full archive entries rendered at runtime | 4,920 |
| Attached source references at runtime | 7,253 |
| Distinct stored source URLs at runtime | 5,864 |
| Current entries with Maybe / Therefore | 193 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 193 |

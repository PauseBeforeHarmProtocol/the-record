...
Generated deterministically from canonical JSON for maintenance release **10.86.0**. Editorial news currentness was checked **2026-09-22 12:02 PM EDT**; QA inputs were updated **2026-09-22T16:12:00Z**.
...
| Current national entries bridged into the archive | 274 |
| Full archive entries rendered at runtime | 5,005 |
| Attached source references at runtime | 7,491 |
| Distinct stored source URLs at runtime | 6,100 |
| Current entries with Maybe / Therefore | 278 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 278 |

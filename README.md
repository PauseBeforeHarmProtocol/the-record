...
Generated deterministically from canonical JSON for maintenance release **10.82.0**. Editorial news currentness was checked **2026-09-21 12:01 PM EDT**; QA inputs were updated **2026-09-21T16:01:57Z**.
...
| Current national entries bridged into the archive | 264 |
| Full archive entries rendered at runtime | 4,995 |
| Attached source references at runtime | 7,471 |
| Distinct stored source URLs at runtime | 6,080 |
| Current entries with Maybe / Therefore | 268 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 268 |

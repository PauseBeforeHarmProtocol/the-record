...
Generated deterministically from canonical JSON for maintenance release **10.41.0**. Editorial news currentness was checked **2026-09-09 6:01 PM EDT**; QA inputs were updated **2026-09-09T22:01:56Z**.
...
| Current national entries bridged into the archive | 164 |
| Full archive entries rendered at runtime | 4,895 |
| Attached source references at runtime | 7,181 |
| Distinct stored source URLs at runtime | 5,793 |
| Current entries with Maybe / Therefore | 168 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 168 |

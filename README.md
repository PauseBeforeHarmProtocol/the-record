...
Generated deterministically from canonical JSON for maintenance release **10.81.0**. Editorial news currentness was checked **2026-09-20 11:58 PM EDT**; QA inputs were updated **2026-09-21T03:58:02Z**.
...
| Current national entries bridged into the archive | 262 |
| Full archive entries rendered at runtime | 4,993 |
| Attached source references at runtime | 7,462 |
| Distinct stored source URLs at runtime | 6,071 |
| Current entries with Maybe / Therefore | 266 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 266 |

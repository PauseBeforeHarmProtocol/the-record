...
Generated deterministically from canonical JSON for maintenance release **10.51.0**. Editorial news currentness was checked **2026-09-13 12:00 AM EDT**; QA inputs were updated **2026-09-13T04:07:07Z**.
...
| Current national entries bridged into the archive | 187 |
| Full archive entries rendered at runtime | 4,918 |
| Attached source references at runtime | 7,242 |
| Distinct stored source URLs at runtime | 5,853 |
| Current entries with Maybe / Therefore | 191 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 191 |

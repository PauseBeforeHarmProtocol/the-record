...
Generated deterministically from canonical JSON for maintenance release **10.1.0**. Editorial news currentness was checked **2026-08-29 11:59 PM EDT**; QA inputs were updated **2026-08-30T04:00:00Z**.
...
| Current national entries bridged into the archive | 68 |
| Full archive entries rendered at runtime | 4,804 |
| Attached source references at runtime | 6,870 |
| Distinct stored source URLs at runtime | 5,480 |
| Current entries with Maybe / Therefore | 72 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 72 |

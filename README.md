...
Generated deterministically from canonical JSON for maintenance release **10.72.0**. Editorial news currentness was checked **2026-09-18 12:00 PM EDT**; QA inputs were updated **2026-09-18T16:15:00Z**.
...
| Current national entries bridged into the archive | 246 |
| Full archive entries rendered at runtime | 4,977 |
| Attached source references at runtime | 7,414 |
| Distinct stored source URLs at runtime | 6,023 |
| Current entries with Maybe / Therefore | 250 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 250 |

...
| Current national entries bridged into the archive | 186 |
| Full archive entries rendered at runtime | 4,917 |
| Attached source references at runtime | 7,238 |
| Distinct stored source URLs at runtime | 5,849 |
| Current entries with Maybe / Therefore | 190 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 190 |

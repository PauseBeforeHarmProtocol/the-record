...
Generated deterministically from canonical JSON for maintenance release **10.46.0**. Editorial news currentness was checked **2026-09-11 5:58 AM EDT**; QA inputs were updated **2026-09-11T10:12:09.583135Z**.
...
| Current national entries bridged into the archive | 178 |
| Full archive entries rendered at runtime | 4,909 |
| Attached source references at runtime | 7,210 |
| Distinct stored source URLs at runtime | 5,822 |
| Current entries with Maybe / Therefore | 182 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 182 |

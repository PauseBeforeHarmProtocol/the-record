...
Generated deterministically from canonical JSON for maintenance release **10.80.0**. Editorial news currentness was checked **2026-09-20 12:01 PM EDT**; QA inputs were updated **2026-09-20T16:01:07Z**.
...
| Current national entries bridged into the archive | 258 |
| Full archive entries rendered at runtime | 4,989 |
| Attached source references at runtime | 7,456 |
| Distinct stored source URLs at runtime | 6,065 |
| Current entries with Maybe / Therefore | 262 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 262 |

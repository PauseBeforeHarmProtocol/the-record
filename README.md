...
Generated deterministically from canonical JSON for maintenance release **10.71.0**. Editorial news currentness was checked **2026-09-18 5:59 AM EDT**; QA inputs were updated **2026-09-18T04:09:14Z**.
...
| Current national entries bridged into the archive | 241 |
| Full archive entries rendered at runtime | 4,972 |
| Attached source references at runtime | 7,406 |
| Distinct stored source URLs at runtime | 6,015 |
| Current entries with Maybe / Therefore | 245 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 245 |

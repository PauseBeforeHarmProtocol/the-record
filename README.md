...
Generated deterministically from canonical JSON for maintenance release **10.19.1**. Editorial news currentness was checked **2026-09-03 6:02 PM EDT**; QA inputs were updated **2026-09-03T22:02:32Z**.
...
| Current national entries bridged into the archive | 119 |
| Full archive entries rendered at runtime | 4,850 |
| Attached source references at runtime | 7,030 |
| Distinct stored source URLs at runtime | 5,642 |
| Current entries with Maybe / Therefore | 123 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 123 |

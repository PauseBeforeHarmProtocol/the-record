...
Generated deterministically from canonical JSON for maintenance release **10.84.0**. Editorial news currentness was checked **2026-09-21 11:57 PM EDT**; QA inputs were updated **2026-09-22T03:57:18Z**.
...
| Current national entries bridged into the archive | 267 |
| Full archive entries rendered at runtime | 4,998 |
| Attached source references at runtime | 7,479 |
| Distinct stored source URLs at runtime | 6,088 |
| Current entries with Maybe / Therefore | 271 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 271 |

...
Generated deterministically from canonical JSON for maintenance release **10.40.0**. Editorial news currentness was checked **2026-09-09 12:01 PM EDT**; QA inputs were updated **2026-09-09T16:01:38Z**.
...
| Current national entries bridged into the archive | 162 |
| Full archive entries rendered at runtime | 4,893 |
| Attached source references at runtime | 7,172 |
| Distinct stored source URLs at runtime | 5,784 |
| Current entries with Maybe / Therefore | 166 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 166 |

...
Generated deterministically from canonical JSON for maintenance release **10.2.0**. Editorial news currentness was checked **2026-08-30 6:02 AM EDT**; QA inputs were updated **2026-08-30T10:02:00Z**.
...
| Current national entries bridged into the archive | 69 |
| Full archive entries rendered at runtime | 4,805 |
| Attached source references at runtime | 6,875 |
| Distinct stored source URLs at runtime | 5,485 |
| Current entries with Maybe / Therefore | 73 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 73 |

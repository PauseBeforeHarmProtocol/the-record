...
Generated deterministically from canonical JSON for maintenance release **10.39.0**. Editorial news currentness was checked **2026-09-09 6:00 AM EDT**; QA inputs were updated **2026-09-09T10:00:31Z**.
...
| Current national entries bridged into the archive | 160 |
| Full archive entries rendered at runtime | 4,891 |
| Attached source references at runtime | 7,168 |
| Distinct stored source URLs at runtime | 5,780 |
| Current entries with Maybe / Therefore | 164 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 164 |

...
Generated deterministically from canonical JSON for maintenance release **10.67.0**. Editorial news currentness was checked **2026-09-16 5:58 PM EDT**; QA inputs were updated **2026-09-16T21:58:16Z**.
...
| Current national entries bridged into the archive | 228 |
| Full archive entries rendered at runtime | 4,959 |
| Attached source references at runtime | 7,369 |
| Distinct stored source URLs at runtime | 5,980 |
| Current entries with Maybe / Therefore | 232 |
| Current entries awaiting Maybe / Therefore | 0 |
| Current entries explicitly reviewed or corrected | 232 |

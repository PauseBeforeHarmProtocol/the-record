...
<article class="route-card"><div class="eyebrow">Weekly</div><h3>What happened this week</h3><p>{len(weekly)} current records in a stable {WEEK_LABEL} window, with working scope filters and search.</p><a class="button button--ghost" href="weekly/index.html">Open weekly</a></article>
<article class="route-card"><div class="eyebrow">National</div><h3>National current record</h3><p>{national_count} sourced developments, each separated into facts, significance, and the administration’s response.</p><a class="button button--ghost" href="national/index.html">Open national</a></article>
...
def archive_page() -> str:
    body = f'''<div class="container"><header class="page-head"><div class="eyebrow">Preserved history</div><h1>Open the complete archives</h1><p>The {RELEASE_DATE} release is the current front door. The long-form national and IN-6 archives remain available at their established repository paths and public builds.</p></header><section class="download-grid">

...
def header(active: str, prefix: str) -> str:
    links = [
        ...
        ("truth-feed", "Truth Social", f"{prefix}the-record.html#feed"),
...
<article class="download-card"><div class="eyebrow">Primary archive · current {RELEASE_DATE}</div><h3>Trump Accountability Archive</h3><p>Search the full historical timeline, browse by topic, year, or person, inspect sources, search Trump's raw Truth Social feed, and read the methodology and companion analysis. The latest verified national entries are included in the same application.</p><a class="button button--primary" href="../the-record.html#home">Enter the full archive</a><p class="micro"><a href="../the-record.html#timeline">Open timeline directly</a> · <a href="../the-record.html#feed">Open Truth Social feed</a> · <a href="https://github.com/PauseBeforeHarmProtocol/the-record" target="_blank" rel="noopener">Source repository</a></p></article>
